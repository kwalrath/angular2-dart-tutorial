...
@Component(selector: 'hello-app', componentServices: const[GreetingService], template: const TemplateConfig(inline: '''<div class=\"greeting\">{{greeting}} <span red>world</span>!</div>
             <button class=\"changeButton\" (click)=\"changeGreeting()\">change greeting</button>''', directives: const[RedDec]))
class HelloCmp {
String greeting;
